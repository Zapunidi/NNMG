...
def createModel(dropout=True):
    ...
    gruOctave1 = tf.keras.layers.GRU(32, return_sequences=True, name="gruOctave1")(concatenateInputOctave)
    if dropout:
        gruOctave1 = tf.keras.layers.Dropout(0.05)(gruOctave1)
    gruOctave2 = tf.keras.layers.GRU(32, return_sequences=True, name="gruOctave2")(gruOctave1)
    if dropout:
