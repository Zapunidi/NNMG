...
def createModel(dropout=True):
    ...
    if dropout:
        gruDT1 = tf.keras.layers.Dropout(0.2)(gruDT1)
    gruDT2 = tf.keras.layers.GRU(32, return_sequences=True, name="gruDT2")(gruDT1)
    if dropout:
        gruDT2 = tf.keras.layers.Dropout(0.2)(gruDT2)
    ...
    if dropout:
        gruMessage1 = tf.keras.layers.Dropout(0.2)(gruMessage1)
    gruMessage2 = tf.keras.layers.GRU(64, return_sequences=True, name="gruMessage2")(gruMessage1)
    if dropout:
        gruMessage2 = tf.keras.layers.Dropout(0.2)(gruMessage2)
