...
def createModel(dropout=True):
    ...
    concatenateOutputMessage = tf.keras.layers.concatenate([outputDT, gruMessage1, gruMessage2],
    ...
    concatenateOutputValue = tf.keras.layers.concatenate([outputDT, outputMessage, gruValue1, gruValue2, gruValue3],
